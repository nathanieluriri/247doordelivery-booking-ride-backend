...
async def login(request: Request):
    base_url = request.url_for("driver_root")
...
@router.get("/",name="driver_root",response_model_exclude={"data": {"__all__": {"password"}}}, response_model=APIResponse[List[DriverOut]],response_model_exclude_none=True,dependencies=[Depends(verify_any_token)])
